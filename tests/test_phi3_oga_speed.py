...
def test_oga_speed():
    # Testing the 14B Phi-3-medium OGA model
    model_path = "models/Phi-3-medium-4k-instruct-OGA/directml-int4-awq-block-128"
    ...
    prompt = "Explain the difference between a microservices architecture and a monolith:"
